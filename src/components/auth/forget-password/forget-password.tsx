...
const ForgotPassword = () => {
  ...
  return (
    <div className="py-6 px-5 sm:p-8 bg-white dark:bg-neutral-800 rounded-lg w-screen md:max-w-md h-screen md:h-auto flex flex-col justify-center  dark:border-neutral-700 border">
      ...
      <p className="text-center dark:text-gray text-sm md:text-base leading-relaxed text-body mt-4 sm:mt-5 mb-7 sm:mb-10">
      ...
      <div className="text-sm sm:text-base text-body text-center dark:text-gray">
      Voltar para {" "}
        <button
