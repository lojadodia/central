    ...
    <div className={props.className}>
      ...
      {checkoutData && (
        <div className="mt-2">
          ...
          <div className="flex justify-between mb-2">
            <p className="text-sm text-body dark:text-neutral">
          ...
          {discount ? (
            <div className="flex justify-between mb-4">
              <p className="text-sm text-body dark:text-neutral mr-4">
                Desconto
              </p>
          ...
          <div className="flex justify-between border-t-4 border-double border-rgb dark:border-neutral-700 pt-4">
            <p className="text-base text-xl  font-semibold text-heading dark:text-white">
              Total
            </p>
            <span className="text-base text-xl font-semibold text-heading dark:text-white">
              {total}
            </span>
          </div>
        </div>
