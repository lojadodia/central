  ...
  (
    ...
    return (
      <div className={className}>
        <label htmlFor={name} className="block mb-2 text-sm text-body dark:text-gray">
          {label} 
        </label>
        <Cleave
          id={name}
          name={name}
          className={cn(
            "py-3 px-4 w-full rounded appearance-none transition duration-300 ease-in-out text-heading text-sm dark:text-white focus:outline-none focus:ring-0",
            shadow && "focus:shadow",
