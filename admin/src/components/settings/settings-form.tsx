    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="flex flex-wrap my-5 sm:my-8">
        ...
        <Card className="w-full sm:w-8/12 md:w-2/3">
          ...
          <Label className="pt-5">Observações em Produtos</Label>
            <Radio
              label="Ativo"
              {...register("site.obs")}
              id="OBS_ACTIVE"
      ...
      <div className="flex flex-wrap my-5 sm:my-8">
        ...
        <Card className="w-full sm:w-8/12 md:w-2/3">
          <div className="relative col-span-4 w-full">
            ...
            <div className={dataAddress?.length > 0 ? "list-outside md:list-inside absolute top-20 bg-white w-full w-88 border border-primary mt-1 z-50" : ""} >
              {
                      ...
                      <>
                        {
                          item ? (
                            <ul key={item?.id}>
                              <li onClick={() => getAddress(item)} className="px-5 py-2 border-b hover:bg-gray-100 cursor-pointer">
