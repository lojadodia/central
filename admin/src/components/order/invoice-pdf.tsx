...
export default function InvoicePdf({ order }: { order: Order }) {
  ...
  return (
    <Document title={`Pedido nº ${order.tracking_number}`}>
      <Page size="A4">
        <View style={styles.container}>
          ...
          <View style={styles.addressWrapper}>
            ...
            <Text style={[styles.addressText, { marginBottom: 20 }]}>
              ...
              <Text style={styles.addressText}>{settings?.site?.email}</Text>
              <Text style={styles.addressText}>{settings?.site?.contact}</Text>
            ...
            <Text style={[styles.addressTextRight, { marginBottom: 20 }]}>
              ...
              <Text style={styles.addressTextRight}>{order?.customer?.email}</Text>
          ...
          <View style={styles.totalCountWrapper}>
            ...
            <View style={styles.totalCountRow}>
              <Text style={styles.totalCountCell}>Desconto</Text>
              <Text style={styles.totalCountCell}>{discount}</Text>
            </View>
            <View style={styles.totalCountRow}>
              <Text style={styles.totalCountCell}>Taxa</Text>
              <Text style={styles.totalCountCell}>{sales_tax}</Text>
            </View>
            <View style={styles.totalCountRow}>
              <Text style={styles.totalCountCell}>Taxa de Entrega</Text>
