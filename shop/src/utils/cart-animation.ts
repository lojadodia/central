export const cartAnimation = (event: any) => {
  ...
  image.style =
    "z-index: 11111; width: 250px;opacity:1; position:fixed; top:" +
    disTop +
    "px;left:" +
    disLeft +
    "px;transition: left 1.5s, top 1.5s, width 1.5s, opacity 1.5s cubic-bezier(1, 1, 1, 1);border-radius: 50px; overflow: hidden; box-shadow: 0 21px 36px rgba(0,0,0,0.1)";
