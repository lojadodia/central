...
import { AddToCartMini } from "@components/product/add-to-cart/add-to-cart-mini";
...
const Mini: React.FC<MiniProps> = ({ product, className }) => {
  ...
  return (
    ...
    >
      <div
        className="relative flex items-center justify-center cursor-pointer w-auto h-47"
      ...
      : (
        quantity > 0 ? (
          <div>
            <AddToCartMini variant="neon" data={product} isOpen={product_type !== "simple" } handlerModal={handleProductQuickView} />          
