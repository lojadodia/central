...
export default function ForgotPasswordPage() {
  return (
    <div className="flex items-center justify-center h-screen bg-white dark:bg-neutral-900  sm:bg-gray-100 dark:bg-black ">
      <div className="m-auto max-w-sm w-full bg-white dark:bg-neutral-900  sm:shadow p-5 sm:p-8 rounded">
