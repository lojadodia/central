        ...
        {open && (
          ...
          >
            {/* <button
              ...
              className={cn(
                "fixed z-10 inline-flex items-center justify-center w-7 h-7 md:w-8 md:h-8 rounded-full bg-white dark:bg-neutral-900  shadow text-gray-600 dark:text-neutral transition duration-200 focus:outline-none focus:text-gray-800 focus:shadow-md hover:text-gray-800 hover:shadow-md",
            ...
            >
              <div
                ref={modalInnerRef}
                className={cn(
                  "w-full absolute left-1/2 transform  -translate-x-1/2   overflow-x-hidden",
