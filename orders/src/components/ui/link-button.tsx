...
const classes = {
  ...
  disabled:
    "border border-gray-300 dark:border-neutral-500 bg-gray-300 border-gray-400 text-gray-500 cursor-not-allowed",
  disabledOutline: "border border-gray-300 dark:border-neutral-500 text-gray-400 cursor-not-allowed",
