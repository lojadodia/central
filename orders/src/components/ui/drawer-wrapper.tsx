...
const DrawerWrapper: React.FunctionComponent<DrawerWrapperProps> = ({
  ...
  return (
    <div className="flex flex-col h-full relative">
      <div className="flex items-center justify-between px-5 md:py-5 md:px-8 mb-4 md:mb-6 border-b border-gray-200 dark:border-neutral-600 border-opacity-75 absolute top-0 left-0 w-full h-16 z-30">
