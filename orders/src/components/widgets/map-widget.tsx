...
const MapWidget = ({ data, totalText }: any) => {
  ...
  return (
    <div className="bg-white dark:bg-neutral-900  shadow-sm rounded w-full h-full">
      <div className="flex w-full my-auto mx-0 py-12 px-9">
        <div className="w-5/12 flex flex-col items-center justify-center py-12 pr-8">
          ...
          <span className="text-xl text-heading dark:text-white font-medium">
            {numberWithCommas(
          ...
          {data.map((item: any, index: number) => (
            ...
            >
              <div className="w-full flex items-baseline mb-3">
                <span className="text-sm text-heading dark:text-white font-medium">
                  {item.name}
                </span>
                <span className="text-xs font-medium  text-heading dark:text-white ml-2">
      ...
      <div className="w-full flex border border-gray-100 dark:border-neutral-700">
