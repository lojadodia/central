...
export default function CreateOrUpdateProductForm({
  ...
  const methods = useForm<FormValues>({
    ...
    defaultValues: initialValues
      ? {
          ...initialValues,
          custom_variation: JSON.parse(initialValues.custom_variation),
          isVariation:
          ...
          productTypeValue: initialValues.product_type
            ...
            : productType[0],
          variations: getFormattedVariations((initialValues?.custom_variation ? JSON.parse(initialValues?.custom_variation): undefined) || initialValues?.variations || []),
        }
      : defaultValues,
  });
  const {
