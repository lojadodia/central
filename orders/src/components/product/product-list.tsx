...
export type IProps = {
	scroll?: Array<object> | null;
	products?: ProductPaginator;
	defineColumns?: Array<object> | null
	onPagination: (current: number) => void;
};

const ProductList = ({ products, onPagination, defineColumns = null, scroll = null }: IProps) => {
	...
	return (
		<>
			<div className="rounded overflow-hidden shadow mb-6">
				{/* @ts-ignore */}
				<Table columns={defineColumns || columns} data={data} scroll={scroll}
				 rowKey="id" />
			</div>
