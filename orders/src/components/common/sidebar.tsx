...
const Sidebar = () => {
  ...
  if(permission == "super_admin" || permission == "admin" || permission == "billing" || permission == "logistics"){
    var MENU_WEEKLY : any = { href: ROUTES.WEEKLY_MENU, label: "Programações", icon: "OrdersStatusIcon" };
  }else{
    var MENU_WEEKLY : any = {};
  }
  ...
  return (
    <aside style={{overflowX:"scroll"}} className="shadow w-72 xl:w-76 hidden lg:block overflow-y-auto bg-white dark:bg-neutral-900  px-4 fixed left-0 bottom-0 h-full pt-20">
