...
const classes = {
  root:
    "pl-10 pr-4 h-12 flex items-center w-full rounded appearance-none transition duration-300 ease-in-out text-heading dark:text-white text-sm focus:outline-none focus:ring-0",
  normal:
